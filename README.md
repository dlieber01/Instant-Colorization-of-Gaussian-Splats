...
<div style="text-align: center; padding:10px;">
  <img src="assets/icgs_gif_short.gif" width="700">
</div>
...
<div style="display:flex; gap:10px; align-items:flex-start; flex-wrap:wrap;">
  ...
  <div style="flex:1 1 48%; min-width:300px;">
    <img src="assets/architecture_overview.png" style="width:600px;background-color:white; padding:5px; box-sizing:border-box;">
  </div>
